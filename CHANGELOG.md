...
* **a11y:** add aria-labels, label associations, and contrastRatio utility ([12b5cb5](https://github.com/pedrofuentes/arbol/commit/12b5cb5d9e062b8e269edcc9e0ee77c8392f24b9))
* add 1000-person sample org CSV ([b21c156](https://github.com/pedrofuentes/arbol/commit/b21c156e8eac8f594e53482184169d0365a26aa2))
* add advanced analytics visualizations (sunburst, span chart, treemap) ([a314d2e](https://github.com/pedrofuentes/arbol/commit/a314d2e71d2236c168d715e4936be7c9b5d4ed1f))
* add Analytics section to help dialog ([293cb30](https://github.com/pedrofuentes/arbol/commit/293cb3027fcde7b5ea11028a1b95c1be39511e5e))
* add ARIA tree semantics and keyboard navigation to SVG org chart ([d0b6d6d](https://github.com/pedrofuentes/arbol/commit/d0b6d6db64702e3d0c8bdfee472c2ca720eff805))
* add backup & restore functionality ([b16391e](https://github.com/pedrofuentes/arbol/commit/b16391e55195d2d69e6dc14564aa967b1aad3d18))
* add bug report & feature request link to footer center ([dcd5464](https://github.com/pedrofuentes/arbol/commit/dcd546459bd525f89dc96499a95ca0ad80bf7ad5))
* add card border radius and font family options ([abbedb4](https://github.com/pedrofuentes/arbol/commit/abbedb41cc40fdf1ddf88d1fed11e1e20fb3537c))
* add CategoryPreset and LevelMappingPreset types ([67b195b](https://github.com/pedrofuentes/arbol/commit/67b195b70aecfd1566411207fdd41c443d5ec71c))
* add CategoryPresetStore with localStorage-backed category presets ([ba19751](https://github.com/pedrofuentes/arbol/commit/ba1975101c3fbad2a0f47ad84317eaea45bf6ff1))
* add Clear All Data button to settings panel ([e3c447f](https://github.com/pedrofuentes/arbol/commit/e3c447f38245a8d688856f7a845f441e20e96943))
* add collapsible accordion sections + per-group reset in settings panel ([955aae9](https://github.com/pedrofuentes/arbol/commit/955aae96d4e16ba85e043a6e43332b4982d3b30d))
* add collapsible sidebar with toggle and keyboard shortcut ([b0dc886](https://github.com/pedrofuentes/arbol/commit/b0dc886a03d628ccbe535d93a23f2bf9d1fc6e53))
* add Command Palette (Ctrl+K) — Step 1 of UX redesign ([eca6dbb](https://github.com/pedrofuentes/arbol/commit/eca6dbb4c1d082a465d9fb82dde08d787da971bb))
* add custom input dialog replacing native prompt() ([117c060](https://github.com/pedrofuentes/arbol/commit/117c060115a4bfaa38ee74c6b24e383c9cc3db90))
* add disclaimer note to analytics help section ([6ec678b](https://github.com/pedrofuentes/arbol/commit/6ec678b7581804830a1baa3e7ad3ccd2d4c05134))
* add dotted-line reporting relationships ([540a817](https://github.com/pedrofuentes/arbol/commit/540a8177453c45ba2b3085708f80d03c8a739d55))
* add dotted-line reporting relationships ([ed32989](https://github.com/pedrofuentes/arbol/commit/ed3298957a0ebfce884883cf4671d37caa3a0cca))
* add drawer drag-to-resize and configurable span health zones ([5bec1a6](https://github.com/pedrofuentes/arbol/commit/5bec1a6a07c532a69f18e1c05fb94cf33ff83693))
* add duplicate chart functionality ([21038f7](https://github.com/pedrofuentes/arbol/commit/21038f710335496c367442a9a23404ea7c299f71))
* add fit, reset, and zoom percentage to preview strip ([5c55b22](https://github.com/pedrofuentes/arbol/commit/5c55b22439f68c132f81871bdded8f8706532041))
* add Focus on sub-org context menu option ([25f7429](https://github.com/pedrofuentes/arbol/commit/25f74294f0ed44fe31a11d4bf4136414fb2e8dc1))
* add global screen reader announcement system ([57f336b](https://github.com/pedrofuentes/arbol/commit/57f336b0e86a0e52defd2ab9db79c049adaa478a))
* add grab cursor to settings preview ([36be081](https://github.com/pedrofuentes/arbol/commit/36be0812cfe85cc826a9cf9a733a3e4cc0bba722))
* add i18n infrastructure with English translations ([9a570e9](https://github.com/pedrofuentes/arbol/commit/9a570e9e85d1ed50d132240ecdf187cb3b9a2c7e))
* add i18n keys for analytics help and tooltips ([1aa486a](https://github.com/pedrofuentes/arbol/commit/1aa486a5c6fb90fca1bdf6bbb4b0b93fbd956e9d))
* add i18n keys for category and level mapping presets ([420d08b](https://github.com/pedrofuentes/arbol/commit/420d08bdf9988fa1ccb4d568306ac6f87ab91071))
* add IC container border radius option ([cf8c800](https://github.com/pedrofuentes/arbol/commit/cf8c8003c2821064998ae5f98cf887fd412bb026))
* add Import Wizard — Step 4 of UX redesign ([692fc97](https://github.com/pedrofuentes/arbol/commit/692fc97b5e03208294152c9d4f2449934a9aa48c))
* add info tooltips to analytics KPI cards ([cd58d87](https://github.com/pedrofuentes/arbol/commit/cd58d872f2c01639e5f18046468bcce32904f932))
* add keyboard accessibility to chart items, drop zone, header, preset delete ([e10040a](https://github.com/pedrofuentes/arbol/commit/e10040a2b21db4bccddd0783f41fe0b2dbbf952a))
* add keyboard navigation for context menu submenus ([513ebcc](https://github.com/pedrofuentes/arbol/commit/513ebcc420a967be30a89d3405edfdd570135b20))
* add keyboard navigation to manager picker listbox ([b5b77c7](https://github.com/pedrofuentes/arbol/commit/b5b77c7923caf981fb0f2180ec8932d4793d403a))
* add level column support to CSV import ([fefa3cc](https://github.com/pedrofuentes/arbol/commit/fefa3cc54ecd694e157c7ca0df31effd64448cbd))
* add Level Mapping settings panel ([b242c72](https://github.com/pedrofuentes/arbol/commit/b242c72c732f477c5e3f2a0dbf524ffc5d5f68a7))
* add level tracking in tree-diff and context menu level submenu ([fa998f5](https://github.com/pedrofuentes/arbol/commit/fa998f5ecef32677ba3a6e7cefcb9b8dc6f82777))
* add LevelPresetStore with localStorage-backed level mapping presets ([9d24d0b](https://github.com/pedrofuentes/arbol/commit/9d24d0b1b371e28e6502cd23c30e46848bd3453e))
* add live preview strip to settings modal ([89d0ea6](https://github.com/pedrofuentes/arbol/commit/89d0ea60a5f06cc2eb4f8895cc5554129f0f42ee))
* add Load Sample Org Chart to Help dialog ([9934182](https://github.com/pedrofuentes/arbol/commit/9934182f272332c01d143584a053e4212bba5b3d))
* add loading state indicators for async operations ([ffe1eed](https://github.com/pedrofuentes/arbol/commit/ffe1eed0a8eae17d53a86bfa1ec5ba0c36a62b30))
* add Microsoft Sans Serif font, use for Ocean Teal preset ([7167470](https://github.com/pedrofuentes/arbol/commit/7167470490ccf48c313ce6a1bc5bae3b1ea4184e))
* add mini card preview to settings panel ([3f66acb](https://github.com/pedrofuentes/arbol/commit/3f66acb7a58fa4fdd8956136ef5da2d1bb32db7d))
* add optional headcount badge on manager cards ([297470a](https://github.com/pedrofuentes/arbol/commit/297470a48f665f0f422e5e587902a94182b969b2))
* add per-node color categories with legend ([5debb08](https://github.com/pedrofuentes/arbol/commit/5debb081137b9ed94d0486b76088e664e6088f84))
* add per-node color categories with legend ([aefb49e](https://github.com/pedrofuentes/arbol/commit/aefb49eee0a0f13c66f229c836d8cf5b5acf0a3d))
* add preview renderer with live SVG in settings modal ([a1ca1d6](https://github.com/pedrofuentes/arbol/commit/a1ca1d698554da64db51bdc9a847151ff96b36ef))
* add privacy messaging and Clear All Data button ([15d5e53](https://github.com/pedrofuentes/arbol/commit/15d5e530804ad1912dd4ad724c2ccc75c4a49bf8))
* add Property Panel + Floating Actions — Step 2 of UX redesign ([b8326c2](https://github.com/pedrofuentes/arbol/commit/b8326c2ff49537e288c8039352acdfa210c93803))
* add resolveLevel option to chart renderer and PPTX exporter ([34dc3ee](https://github.com/pedrofuentes/arbol/commit/34dc3eec668b114321110f9350327fb995c3b8c6))
* add reusable PresetToolbar UI component ([1906c8c](https://github.com/pedrofuentes/arbol/commit/1906c8c8e46c842216708c526961c54bbb0c392b))
* add right-click context menu with inline card editing ([a9a9469](https://github.com/pedrofuentes/arbol/commit/a9a9469df432c1d73f5dc0d38188cb4bab2f2aaf))
* add Settings Modal — Step 3 of UX redesign ([6f12748](https://github.com/pedrofuentes/arbol/commit/6f12748aedaf6c32f0dd5e72d89a3686721f7964))
* add settings quick-filter/search input ([34cf489](https://github.com/pedrofuentes/arbol/commit/34cf489c09a0c1bf27aac280d79601962797a2ff))
* add sidebar tabs with analytics panel ([df8f481](https://github.com/pedrofuentes/arbol/commit/df8f481c505626ecfb3f7307cfc1628d3678c619))
* add Stone theme preset with green borders and blue connectors ([d45265a](https://github.com/pedrofuentes/arbol/commit/d45265aecfd9161a52085f23177b96b1a5a1dd47))
* add text alignment option and Ocean Teal theme preset ([ffcf1ee](https://github.com/pedrofuentes/arbol/commit/ffcf1ee81f076d9ea4b78d8b895f671be7552c43))
* add text normalization options on import ([222a344](https://github.com/pedrofuentes/arbol/commit/222a344cc614d37b847003fd88df7fd2a70347c6))
* add timestamp prefix to all file exports ([19f3db4](https://github.com/pedrofuentes/arbol/commit/19f3db4f477b3c90a9aef9fcce3e844c707f37e5))
* add toast notification system ([54a076e](https://github.com/pedrofuentes/arbol/commit/54a076ec2dea4475567f3cd93b18bc1337f65cd1))
* add toggle to disable dimming of unchanged nodes ([46fd09e](https://github.com/pedrofuentes/arbol/commit/46fd09e5a6ec0af131bf9e59835c579f2e02fd5c))
* add tree favicon with PNG fallbacks ([90bf336](https://github.com/pedrofuentes/arbol/commit/90bf336300b4c11a41a851a1276fe31c97dd40f0))
* add Utilities tab with text normalization for existing org chart ([9e6c5c6](https://github.com/pedrofuentes/arbol/commit/9e6c5c63d5e4ce8469f25f60503d3915a18bbf3e))
* add version comparison with merged and side-by-side views ([770b409](https://github.com/pedrofuentes/arbol/commit/770b4090c9ba293903121bd3270d80373657208e))
* add versioning workflow and display version in footer ([4a27bdc](https://github.com/pedrofuentes/arbol/commit/4a27bdc50f340c9eafacd5751f42594d8f163751))
* add versioning workflow and display version in footer ([c93645f](https://github.com/pedrofuentes/arbol/commit/c93645f3d66395b03e188ecb89aa846d056eae29))
* analytics help — help dialog section + KPI tooltips (v3.11.1) ([74c0452](https://github.com/pedrofuentes/arbol/commit/74c0452db26ef9027c4536cf3cb8a03ae63ccea0))
* analytics help disclaimer (v3.11.2) ([9c71ef6](https://github.com/pedrofuentes/arbol/commit/9c71ef62397b0d24171d63c3f7a7f659e1e369f6))
* ask user to create new chart or replace on import ([cc2b9f1](https://github.com/pedrofuentes/arbol/commit/cc2b9f1b478703926bc5293b51b125bca4ae9c15))
* center org chart horizontally and vertically on load ([dbcd6b0](https://github.com/pedrofuentes/arbol/commit/dbcd6b08490cd2a9e76021c1e83dc9b48038d344))
* chart bundle export/import with versions ([9ca2a1c](https://github.com/pedrofuentes/arbol/commit/9ca2a1cc831379357ad226443170b99acaa213eb))
* configurable legend rows in PPTX and canvas ([f6db690](https://github.com/pedrofuentes/arbol/commit/f6db6904fe46eb99cd3ffe94869973394f95e964))
* configurable name/title text colors with auto-contrast for categories ([a786b8b](https://github.com/pedrofuentes/arbol/commit/a786b8b26c4beafcb35547d7d89d4ed8a15925ae))
* consolidate sidebar tabs 5→3, add category legend, improve footer ([9ed9f9e](https://github.com/pedrofuentes/arbol/commit/9ed9f9ea9108d89b8425303042f1f4f02d3e08eb))
* dual-track level mappings with Manager/IC titles and pinned title override ([9228031](https://github.com/pedrofuentes/arbol/commit/92280312316ea57c9cd4fa8af05c635e66aea21f))
* **editor:** wire create-chart-dialog with preset stores ([2fa7945](https://github.com/pedrofuentes/arbol/commit/2fa7945201a6568fd768347996f60b72fc0df2a7))
* enhanced footer with IC count, manager levels, and GitHub link ([e654129](https://github.com/pedrofuentes/arbol/commit/e654129d2076f4457f9403245072a93bdb42a780))
* enterprise import instructions via build-time config ([#43](https://github.com/pedrofuentes/arbol/issues/43)) ([1086fdd](https://github.com/pedrofuentes/arbol/commit/1086fdd9e556c421479528f9b19d2f554849d50f))
* export dialog with format picker (PPTX/SVG/PNG) ([d48ecd9](https://github.com/pedrofuentes/arbol/commit/d48ecd9074aac3948df82017ca96de39ca5fb8d9))
* file type mismatch warnings for restore/import flows ([221d20b](https://github.com/pedrofuentes/arbol/commit/221d20b9f135a8e3cd23364ef11e4b8a145b7c37))
* four UX improvements — remove org, comparison zoom, auto-version, search fix ([330e479](https://github.com/pedrofuentes/arbol/commit/330e47977604a2b345a1e6d1bcd3bf2c7229bc43))
* harden CSV/XLSX import with validation and better errors ([2b8a838](https://github.com/pedrofuentes/arbol/commit/2b8a8380b6b9879cabe860e261d991f94bc3fb2c))
* **help:** rewrite dialog with accordion sections and shortcuts grid ([13a529d](https://github.com/pedrofuentes/arbol/commit/13a529d2653b9e0ab95a8460b6ed32a20ee3f93c))
* **help:** show help dialog with Getting Started on first visit ([c253b6a](https://github.com/pedrofuentes/arbol/commit/c253b6a71c1822adaca2d2bf626b03544624e60a))
* **help:** show help dialog with Getting Started on first visit ([0db9bba](https://github.com/pedrofuentes/arbol/commit/0db9bbaa2c2be875152103b55edac5e29a5b2f2a))
* **help:** show help dialog with Getting Started on first visit ([#40](https://github.com/pedrofuentes/arbol/issues/40)) ([c253b6a](https://github.com/pedrofuentes/arbol/commit/c253b6a71c1822adaca2d2bf626b03544624e60a))
* **i18n,css:** add keys and styles for help dialog accordion ([2dbe13e](https://github.com/pedrofuentes/arbol/commit/2dbe13e9806e7dd923f7991ce7e211b635194b6e))
* **i18n:** add dialog.create key ([e014f1a](https://github.com/pedrofuentes/arbol/commit/e014f1a185cdb4928417df503ba0ec1db9d75883))
* improve help content, fix terminology, and enhance discoverability ([35e7bf6](https://github.com/pedrofuentes/arbol/commit/35e7bf62a392bbd8064b0785f6e397b35da301ba))
* improve preset UX — auto-match on load, prompt to save on Next ([e003df7](https://github.com/pedrofuentes/arbol/commit/e003df796933936c41d0f2f03a8d3a9351073240))
* include level mappings in chart bundle export/import ([7c5776a](https://github.com/pedrofuentes/arbol/commit/7c5776a20fb5056a2d7bad17facde1579c272d3f))
* inline editing for level mapping rows ([39b67f7](https://github.com/pedrofuentes/arbol/commit/39b67f7fd67833c0a2d981af912067d5799e138b))
* integrate LevelStore with ChartStore for per-chart level persistence ([90aea29](https://github.com/pedrofuentes/arbol/commit/90aea297116c070d1072aaabec0e12d7a100b173))
* language switcher UI with locale persistence ([e8be023](https://github.com/pedrofuentes/arbol/commit/e8be02367a0a8d3645d459678c7dc1f15fabb554))
* level distribution shows raw levels, grouped by bands when mapped ([c7d40f4](https://github.com/pedrofuentes/arbol/commit/c7d40f4e2bd9f244aa24adc3cd8dac2c31130764))
* level mapping replaces job title on cards, not badge text ([36143f8](https://github.com/pedrofuentes/arbol/commit/36143f8b797ac0a675141d2072db62d350239938))
* level metadata + circular badge (Phase 38a) ([26ab199](https://github.com/pedrofuentes/arbol/commit/26ab199174e0e8500786176ed30fb2ce785607e6))
* load org chart at real size instead of fitting to viewport ([eb563fa](https://github.com/pedrofuentes/arbol/commit/eb563fae0efd60f861639196b326ec7b03f35d89))
* multi-chart support with version snapshots ([3e09147](https://github.com/pedrofuentes/arbol/commit/3e091472859232243a13a2d344301c96890ab43b))
* performance optimization — v3.9.0 ([ec75123](https://github.com/pedrofuentes/arbol/commit/ec751235fab935e30ffa2cd331c37810b02cd725))
* prompt to save as preset when closing with modified settings ([13ddfbc](https://github.com/pedrofuentes/arbol/commit/13ddfbc7f20f88c96cb0cd3a2a52a2b424a044ed))
* property panel shows mapped title in summary + disabled field in edit ([f8f07c2](https://github.com/pedrofuentes/arbol/commit/f8f07c2ec7d3b3abd8479da3e3c5a0cda11e440b))
* rebalance layout presets with larger defaults ([7020337](https://github.com/pedrofuentes/arbol/commit/702033795d7775c717fa32a9051342feb2a7b6dc))
* remove floating actions, rename menu items, add dotted toggle to property panel ([76ab29f](https://github.com/pedrofuentes/arbol/commit/76ab29fa94d466843b77ae60cd0f7f5614cc5ab8))
* remove level submenu from right-click context menu ([b08f545](https://github.com/pedrofuentes/arbol/commit/b08f545a66b929096a132b1f900f3c31bbd50dce))
* replace sidebar analytics tab with bottom drawer ([f2b5cfc](https://github.com/pedrofuentes/arbol/commit/f2b5cfcb07ff557ae86dfcd80c587e375254b4a4))
* restructure sidebar to exactly match mockup design ([59f53c8](https://github.com/pedrofuentes/arbol/commit/59f53c81b4d37a2432ebf56f834e6f17f3ea7a82))
* restyle sidebar chart/version items to match mockup design ([78538e9](https://github.com/pedrofuentes/arbol/commit/78538e947e38615995423be9c2ef53d9fcf78df5))
* settings panel UX overhaul — 13 improvements ([545bb07](https://github.com/pedrofuentes/arbol/commit/545bb07b766054cc93e8dc7ec2bafad7c1ae7c37))
* Shift+click multi-select with bulk Move/Remove ([dc9681a](https://github.com/pedrofuentes/arbol/commit/dc9681a4c63ccef3c839febf2043291be3dc48bd))
* **shortcuts,palette:** register ? and Ctrl+, shortcuts, add 5 palette commands ([8a749b8](https://github.com/pedrofuentes/arbol/commit/8a749b85e7c4f73050f7d730dad390929aa61d25))
* show manager count alongside people count in footer ([2185442](https://github.com/pedrofuentes/arbol/commit/2185442f4d0020d6d03992cd070034e45cb6aa66))
* show sample data table in Preview step with live normalization preview ([f1f2e54](https://github.com/pedrofuentes/arbol/commit/f1f2e540036e6029e749ca5c27651ef0d316af5f))
* side-by-side comparison cross-highlighting and dim fix ([83268cc](https://github.com/pedrofuentes/arbol/commit/83268cc1808712d80785f33951837aece10e23be))
* slim sidebar to chart navigator — Step 6 of UX redesign ([4cc5bc9](https://github.com/pedrofuentes/arbol/commit/4cc5bc966a6e577147a331b64736a8b91f4aab0c))
* **store:** extend createChart to accept categories and levels ([6600df1](https://github.com/pedrofuentes/arbol/commit/6600df12960e555b486050cc8a006067061925d8))
* SVG/PNG exporter module ([019748e](https://github.com/pedrofuentes/arbol/commit/019748e9f65300c160e3f55b136bc731cb3c6d0f))
* toggle between grouped/individual level distribution in analytics ([4553b0d](https://github.com/pedrofuentes/arbol/commit/4553b0dea3d8b40a38f86576911ef75efba5ae83))
* **ui:** add showCreateChartDialog with tests ([4b70023](https://github.com/pedrofuentes/arbol/commit/4b70023ba49d97a960cbb93d3ef9bc51bffe524f))
* unify Theme Presets and Layout Presets into single Presets section ([202a99e](https://github.com/pedrofuentes/arbol/commit/202a99e40ab1b0ff6dab4b11e24a5b9bd67e54c5))
* UX improvements (required fields, loading overlay, search UX, footer i18n) ([a68996a](https://github.com/pedrofuentes/arbol/commit/a68996a7b526da93bb98f572426c05f613aa72bb))
* v2.8.0 — accessibility, i18n, mobile responsiveness ([169bdf7](https://github.com/pedrofuentes/arbol/commit/169bdf7aecc01952f7f38639f99c53782ceb4023))
* v3.11.0 — Advanced Analytics Visualizations + Performance ([96ff16a](https://github.com/pedrofuentes/arbol/commit/96ff16a709789260eebb5da15b6512df52f6ac44))
* warn before exporting oversized org charts to PPTX ([6f4c34c](https://github.com/pedrofuentes/arbol/commit/6f4c34c702cba41818a114ff591fe6fb92dfd61f))
* wire functional content into import wizard steps ([f9c05ab](https://github.com/pedrofuentes/arbol/commit/f9c05ab0e996b662e0ce4c385d62d3df07a1acd2))
* wire PresetToolbar into category and level mapping settings panels ([07aba2a](https://github.com/pedrofuentes/arbol/commit/07aba2af6a653147c3ccf59a22c7dbf5d8225900))
* wire SettingsEditor into Settings Modal with tab-based filtering ([30f6115](https://github.com/pedrofuentes/arbol/commit/30f61158362811ad30e41e9190a2529b55e28eb4))


### Bug Fixes

* 8 quick wins from comprehensive code review ([0cf1846](https://github.com/pedrofuentes/arbol/commit/0cf1846dc22f6f2d2ff764960792a71d7ce2f93e))
* accordion-inner padding, rename tab, consistent layout heading ([bddcf34](https://github.com/pedrofuentes/arbol/commit/bddcf343ad226915f3e7e5acb91d2ab69dbca0f5))
* add .mailmap to remap old noreply email ([59cc100](https://github.com/pedrofuentes/arbol/commit/59cc100c69ba22cb784fde1fb5b75a25fd7e999c))
* add 25px bottom margin to all settings sections ([dcd16f4](https://github.com/pedrofuentes/arbol/commit/dcd16f46e92d375e815f1b96d37ad3d1c80a8043))
* add analytics disclaimer, category legend positioning, focus mode refresh ([d6dcb5f](https://github.com/pedrofuentes/arbol/commit/d6dcb5f1d8b942ddf9c9a814f46eef984127719d))
* add error handling to saveVersion and saveWorkingTree ([2223bf2](https://github.com/pedrofuentes/arbol/commit/2223bf2b7b46a34d3cd68fc8dbe8896bcdbb0f1e))
* add focus trapping to settings modal, import wizard, command palette ([38252ce](https://github.com/pedrofuentes/arbol/commit/38252ce41ac6daa4fbc61aab26a0fe77dc5d0b70))
* add global error handler, localStorage toasts, D3 render protection ([af06d31](https://github.com/pedrofuentes/arbol/commit/af06d318ab28cc16f1a6a0c65341c45a429e8ac4))
* add margin-bottom to dropzone and margin-top to paste area ([28e8551](https://github.com/pedrofuentes/arbol/commit/28e855195d0fd8547cfd03a654c9303a79b4d2a8))
* add missing footer.imported i18n key ([3733fd3](https://github.com/pedrofuentes/arbol/commit/3733fd3a76af7be071a4d9e9e603e0f1cdeadfd1))
* add more spacing around 'Or paste data' label in import wizard ([f20d11e](https://github.com/pedrofuentes/arbol/commit/f20d11ea88de62243b1e29f9658b030acb7a0edb))
* add text label to Import header button ([e444c0c](https://github.com/pedrofuentes/arbol/commit/e444c0c524a3bee9382746667e0d00fc3a1054f3))
* add visual separator and spacing between drop zone and paste area ([cb7dadc](https://github.com/pedrofuentes/arbol/commit/cb7dadc6485d18a3314d9fde4ae5e2fb6c591bde))
* auto-create 'Original' version when importing as new chart ([51200fb](https://github.com/pedrofuentes/arbol/commit/51200fb5c9ac1d7ab0399ae9726f6a1b3dfcb32c))
* backup sections layout to match mock design ([9133958](https://github.com/pedrofuentes/arbol/commit/91339583c00033ff6bf93b4df91c503f619fde34))
* **backup:** atomic restore, backup-failure warning, version validation ([#14](https://github.com/pedrofuentes/arbol/issues/14), [#15](https://github.com/pedrofuentes/arbol/issues/15), [#16](https://github.com/pedrofuentes/arbol/issues/16)) ([6c1dfc8](https://github.com/pedrofuentes/arbol/commit/6c1dfc8c3ac09504774bca116ff886a72838e06b))
* **backup:** surface rollback errors and batch version reads ([#61](https://github.com/pedrofuentes/arbol/issues/61)) ([d8ca6d2](https://github.com/pedrofuentes/arbol/commit/d8ca6d27b64909e2b730926863511956993aea0e))
* **bundle-import:** validate categories, levelMappings, levelDisplayMode on import ([#17](https://github.com/pedrofuentes/arbol/issues/17)) ([2e99237](https://github.com/pedrofuentes/arbol/commit/2e992374104b762702ae4ce1a27334fa62c30176))
* category legend repositions using drawer's actual height ([142dd4c](https://github.com/pedrofuentes/arbol/commit/142dd4c540f19d88174dbf3638b86426c77b730a))
* center entire subtree under parent for single-child with PALs ([b57e5a6](https://github.com/pedrofuentes/arbol/commit/b57e5a65ba5d8997dfa632c3f4959cb302b4c57c))
* chart list export shows JSON dialog instead of PPTX/SVG/PNG ([c747ec2](https://github.com/pedrofuentes/arbol/commit/c747ec2a40624c9e951fe284f81160943659f93b))
* **ci:** fix CI pipeline failures ([55334e0](https://github.com/pedrofuentes/arbol/commit/55334e0d6c3c3531a14f8325919a2fa02afbfc2d))
* **ci:** fix CI pipeline failures ([#100](https://github.com/pedrofuentes/arbol/issues/100)) ([55334e0](https://github.com/pedrofuentes/arbol/commit/55334e0d6c3c3531a14f8325919a2fa02afbfc2d))
* **ci:** fix TypeScript type errors in test files ([74433fe](https://github.com/pedrofuentes/arbol/commit/74433fe7f983490ace2046bfa9d451134ef7c119))
* **ci:** pin GitHub Actions to commit SHAs for supply chain security ([2b02400](https://github.com/pedrofuentes/arbol/commit/2b02400d69487d8f0bd544e1d4f12bad94cd74e5))
* consistent section title styling across all settings tabs ([a1d3082](https://github.com/pedrofuentes/arbol/commit/a1d3082bb5a04b4fc1f5974dd5e554426263e7ab))
* correct vi.fn() typing in preset-toolbar tests ([735f513](https://github.com/pedrofuentes/arbol/commit/735f51304d55e8761bcbede93ee0f56cfd94db00))
* **css:** convert physical to logical properties, fix touch targets and contrast ([e9fd4fd](https://github.com/pedrofuentes/arbol/commit/e9fd4fd74c898ebcabcfafe5a3f7c8c3988b3e67))
* don't clear matched preset on initial prefill, only on user changes ([14a13fb](https://github.com/pedrofuentes/arbol/commit/14a13fb98e981cc1acc1f76cbd3c3262fbfa33b1))
* export PPTX at 1:1 scale matching on-screen 100% zoom ([467b825](https://github.com/pedrofuentes/arbol/commit/467b8252427187e6434271d69eb0bab74f89843b))
* **first-visit:** fix storage mock type to satisfy IStorage interface ([421ef73](https://github.com/pedrofuentes/arbol/commit/421ef73689469b8813e832836b14dae35e0f5d61))
* give UtilitiesEditor and ImportEditor own wrapper divs ([8b11275](https://github.com/pedrofuentes/arbol/commit/8b11275c5a75ed45f5bbda360aa5221f6b5520e6))
* handle trailing HR metadata in CSV imports ([11328cd](https://github.com/pedrofuentes/arbol/commit/11328cd7068cdca4f38873ee784b7fa8791c6f8d))
* **help-dialog:** reorder sections — Getting Started, Import Instructions, Shortcuts ([#50](https://github.com/pedrofuentes/arbol/issues/50)) ([2cdcc42](https://github.com/pedrofuentes/arbol/commit/2cdcc421c821f3b6e2748cc2f1b99fb9c59d5d8b))
* **help:** correct all inaccurate help content to match current app ([ad59c08](https://github.com/pedrofuentes/arbol/commit/ad59c08e38c6c59907cfaecbbe284b9abdcae768))
* **help:** exclusive accordion (one section open at a time) + mobile-friendly welcome ([07dea73](https://github.com/pedrofuentes/arbol/commit/07dea737c81df9eada6e9691341f60fae23fd200))
* hide redundant Apply Mapping button in wizard, auto-apply on change ([3f4cd8f](https://github.com/pedrofuentes/arbol/commit/3f4cd8f1f73b49c566eb6501d8177aab58995f8c))
* **i18n:** wrap hardcoded strings in export-dialog and manager-picker with t() ([fa29cbb](https://github.com/pedrofuentes/arbol/commit/fa29cbbd571d7c792c7e2236ef32441a3799666f))
* **i18n:** wrap hardcoded strings in UI, renderer, and editor files with t() ([c4fc85e](https://github.com/pedrofuentes/arbol/commit/c4fc85eb9e046f95657b9c57e15d68d1378d5f5c))
* IC container starts at vertical midpoint of M1 card ([125653c](https://github.com/pedrofuentes/arbol/commit/125653c1b1a5d629c01548eeabf1ba350ac6be14))
* import wizard now shows newly imported chart as active (GH [#4](https://github.com/pedrofuentes/arbol/issues/4)) ([201968d](https://github.com/pedrofuentes/arbol/commit/201968d3c7024aae1327ed46058574297247e357))
* **import-wizard:** handle ChartBundle format in import wizard ([#52](https://github.com/pedrofuentes/arbol/issues/52)) ([6cd90c5](https://github.com/pedrofuentes/arbol/commit/6cd90c58675d1297d8678819d79b0251582a8c8f))
* **import:** validate bundle import flow ([#62](https://github.com/pedrofuentes/arbol/issues/62)) ([bd5be20](https://github.com/pedrofuentes/arbol/commit/bd5be2090471b667ac52727f54c61d7f3b371c15))
* improve badge width scaling for larger numbers ([920e4b8](https://github.com/pedrofuentes/arbol/commit/920e4b82d62b1e31b4d1c33bfac78fc976ef6f69))
* improve error handling and resilience across stores ([2354d9c](https://github.com/pedrofuentes/arbol/commit/2354d9c307ce1f3fc220ba3887cbfa03c52f5c1f))
* improve theme preset title colors for WCAG AA contrast ([9c27eae](https://github.com/pedrofuentes/arbol/commit/9c27eae508337113bf10271299611ceef70d921e))
* increase category preview card size for readability ([93a3049](https://github.com/pedrofuentes/arbol/commit/93a30495b4e627a96c82e02fea031810e2f5c001))
* level mappings now persist across sessions and chart switches ([fcc10ff](https://github.com/pedrofuentes/arbol/commit/fcc10ff7bbc5e532bafd45c5da5ff23b918c2968))
* link form labels to inputs for screen reader accessibility ([12ae17e](https://github.com/pedrofuentes/arbol/commit/12ae17e393982b51dc5bb8a05733cc6a7bdf6fe0))
* load correct tree after deleting active chart ([0fa892e](https://github.com/pedrofuentes/arbol/commit/0fa892e42db8728f0d842f7b6d14cb2e5825b61d))
* make chart SVG heights dynamic based on container size ([febcde0](https://github.com/pedrofuentes/arbol/commit/febcde03edb1b3b800d124e652b07281e4aa9b43))
* make live previews reactive, remove filter/collapse, cleanup ([8363d18](https://github.com/pedrofuentes/arbol/commit/8363d18b8cccf9f03e503a893370ca83095c51a9))
* make modified indicators and reset buttons reactive ([9a5e70f](https://github.com/pedrofuentes/arbol/commit/9a5e70f4226263ada7e3115cc6334c83b249e78d))
* make settings parseImport() forward-compatible ([99f4223](https://github.com/pedrofuentes/arbol/commit/99f422354f145402eb6c15ec20769f4d426c4b9b))
* match chart UI styling to existing app patterns ([6eb894d](https://github.com/pedrofuentes/arbol/commit/6eb894dca92bd64c6b3c0ea7f447bc51ba3d5a11))
* move zoom controls back to footer per user preference ([323dcb4](https://github.com/pedrofuentes/arbol/commit/323dcb4236913c2e228225de0c0ca843af5ac400))
* only one preset can show Active badge at a time ([e488998](https://github.com/pedrofuentes/arbol/commit/e488998ffed5d1fedd7674a36180951ffe3fb6e5))
* pass app locale to all date formatting calls and add td/tn helpers ([934d7e3](https://github.com/pedrofuentes/arbol/commit/934d7e3baa8beccabfaa4f2c4fc1096cb4ffefce))
* pass headcount badge options to PPTX exporter ([b764e80](https://github.com/pedrofuentes/arbol/commit/b764e80d5a985b5f629b1d6f4883e0d4d7076537))
* place sidebar chevron on #chart-area to avoid overflow clipping ([52d2857](https://github.com/pedrofuentes/arbol/commit/52d285741a53c45f55cd8d48d8b2f88a7a2b2d4d))
* position sidebar chevron on #main instead of #sidebar ([e96ddfe](https://github.com/pedrofuentes/arbol/commit/e96ddfe0911f548e2117909587042272bc775d56))
* pre-populate mapper dropdowns when preset matched, suggest name from filename ([2d44a7a](https://github.com/pedrofuentes/arbol/commit/2d44a7ae53fbfe2c4a279c3d1667f070cb7e83fd))
* preserve level and dottedLine in normalizeTreeText() ([b2c7a07](https://github.com/pedrofuentes/arbol/commit/b2c7a07caa9c96dd1eb028adff5853e50be9309c))
* preset save prompt now checks all preset fields ([be78735](https://github.com/pedrofuentes/arbol/commit/be78735989c05197a05bb83cf0ab77722bdcc859))
* prevent chart list duplication on switch ([948aec1](https://github.com/pedrofuentes/arbol/commit/948aec1fa7c9b9d8b436a2134b5e1c68210dd318))
* prevent PPTX badge text from wrapping to 2 lines ([1416079](https://github.com/pedrofuentes/arbol/commit/14160794df8cb13de69583b4b1429824460c0582))
* prevent value+unit text wrapping on setting rows ([82458b6](https://github.com/pedrofuentes/arbol/commit/82458b6aab40866a77acad24b29fdb5e0602db1c))
* preview height, pan/zoom, and live updates on all controls ([6ee0b05](https://github.com/pedrofuentes/arbol/commit/6ee0b05bc4fd869108699829632de5cb0673abef))
* preview strips CSS class mismatch, layout preset styling ([6ea8e49](https://github.com/pedrofuentes/arbol/commit/6ea8e498bc30cc7580f493c99e0c0c013bc28059))
* re-apply tab filter after settings panel rebuild ([6adbc52](https://github.com/pedrofuentes/arbol/commit/6adbc52f9cd809b2431182dfa66927abc4a5b9b3))
* reduce chart SVG heights so legends are visible in drawer ([17fe396](https://github.com/pedrofuentes/arbol/commit/17fe396fa847964d4b3730826aef87e6cb1dc442))
* remove Apply/Cancel buttons from ColumnMapper, auto-apply on change ([2c5e6fd](https://github.com/pedrofuentes/arbol/commit/2c5e6fd0f3970b47ca27838309c0ad0d27c0b3f8))
* remove slide dimension cap for large org exports ([b671184](https://github.com/pedrofuentes/arbol/commit/b671184f06c68b08c2d7e2e98ac40e17038a4cb3))
* remove text normalization from mapping step, keep only in preview ([7d94be0](https://github.com/pedrofuentes/arbol/commit/7d94be0ec55ca982727410c57c09bd071cc6322b))
* replace silent failures and native dialogs with proper feedback ([1f10748](https://github.com/pedrofuentes/arbol/commit/1f10748113f692f11a05a623158f8e09705a31e8))
* replace stacked paste area with source option buttons ([2a7d84e](https://github.com/pedrofuentes/arbol/commit/2a7d84e9a92c4143d26f8c0639a6e1b750876e27))
* replace vulnerable xlsx with exceljs, bump vitest ([69c5438](https://github.com/pedrofuentes/arbol/commit/69c5438d3d359a6e020bcb2c488bc6026f91062a))
* resolve 19 critical+high findings from code review ([f8bd18a](https://github.com/pedrofuentes/arbol/commit/f8bd18a70f9e08baf4d22ff772376e890d87ba34))
* resolve TypeScript compilation errors in test files ([639f390](https://github.com/pedrofuentes/arbol/commit/639f390749fa14f93ce544751cdd012663bb9d59))
* restore 56-inch PPTX slide dimension cap ([ed5fead](https://github.com/pedrofuentes/arbol/commit/ed5fead03d93c06dd5a514ba0e51ae36e1bd4297))
* restore LevelMapping types, add resolveLevel defaults, version bump + docs ([e15a19d](https://github.com/pedrofuentes/arbol/commit/e15a19d59bb8c8bbc237c164143327765835c736))
* restore preview zoom controls in settings modal ([d6ecb25](https://github.com/pedrofuentes/arbol/commit/d6ecb25c8152a8335e608ac51e32039d335160e0))
* right-click now works on card text, not just background ([a926f7d](https://github.com/pedrofuentes/arbol/commit/a926f7d71ed5fa636bd024da4fa9a0653631e703))
* search highlighting targets individual paths instead of group elements ([29db769](https://github.com/pedrofuentes/arbol/commit/29db769c09247aca67b08644889ed330ae5ebda9))
* **sentinel:** relax agent ID requirement and add background mode dispatch ([706e598](https://github.com/pedrofuentes/arbol/commit/706e5986926c2eb0d656aad0cf679d922af496a2))
* **sentinel:** relax agent ID requirement and add background mode dispatch ([fb330c0](https://github.com/pedrofuentes/arbol/commit/fb330c0edbaba13a9b3f8eec69bec6b9eddd4f02))
* **sentinel:** require dispatch proof for degraded mode; clarify test→fix compliance ([8a2bf0f](https://github.com/pedrofuentes/arbol/commit/8a2bf0f8d341f13f39ccdc85a159a7d45b342fdc))
* **sentinel:** require dispatch proof for degraded mode; clarify test→fix compliance ([091383c](https://github.com/pedrofuentes/arbol/commit/091383cd1b9785ea2690f6e8deff1b5cbf2671b5))
* set .section-intro margin-bottom to 0 ([bb0b6d7](https://github.com/pedrofuentes/arbol/commit/bb0b6d77c9a28aa5646e46fe2e0f17f8bb310a20))
* settings Clear All Data now also clears IndexedDB ([1b9c670](https://github.com/pedrofuentes/arbol/commit/1b9c67091135c5da94fbf0db6e963d05e50cceba))
* settings sections hidden due to i18n-derived section IDs ([edd00c7](https://github.com/pedrofuentes/arbol/commit/edd00c72b10d4952c1430a12b350a265bad310a2))
* show date and time in chart list (not just date) ([07b7332](https://github.com/pedrofuentes/arbol/commit/07b73320dc015075c61b70006c215e244787a8e9))
* show visual feedback when saving mapping preset ([af0f3c7](https://github.com/pedrofuentes/arbol/commit/af0f3c7a51ce1a3900e547105a369dd49daa37ef))
* show zoom percentage relative to fit-to-content base scale ([2170655](https://github.com/pedrofuentes/arbol/commit/2170655cedc869fc0d2f9c876a6dff6b9df877a8))
* skip save-as-preset prompt when settings match existing preset ([0e01edc](https://github.com/pedrofuentes/arbol/commit/0e01edc617aeb52f8e813a7dc995fdccda27093a))
* stable chart list order — sort by createdAt ascending ([d557c83](https://github.com/pedrofuentes/arbol/commit/d557c839e7e273a8b79ffd93145f2fc68e33e5ee))
* standardize all exported filenames to yyyymmddhhmm- prefix ([f257168](https://github.com/pedrofuentes/arbol/commit/f257168185608407dc8637cfd13210608879f493))
* strip CSP meta tag in dev mode for Vite HMR ([f81d28a](https://github.com/pedrofuentes/arbol/commit/f81d28a9103332b204ecd126ef66731b685cdfbe))
* style header buttons with ghost theme matching mockup ([ce8cd97](https://github.com/pedrofuentes/arbol/commit/ce8cd97df390db24e0a3b3e5251c58190d654cc6))
* switch OrgStore to new chart tree after import ([4719bf6](https://github.com/pedrofuentes/arbol/commit/4719bf65829eb0f007815a5380f4edf7615cda5c))
* three UX improvements for chart management ([52260c3](https://github.com/pedrofuentes/arbol/commit/52260c311f5f6cb6cfeb662d551791bc80cc85de))
* toggle button shows 'Collapse all' when all sections expanded ([4adb8c5](https://github.com/pedrofuentes/arbol/commit/4adb8c534fa3c2ab07e97c36527be2f76174d329))
* translate toolbar labels, settings panel, and style locale picker ([009d295](https://github.com/pedrofuentes/arbol/commit/009d295866206a8f92215e0bb7558159ea8fdd6a))
* upgrade flatted 3.4.2 (CVE prototype pollution) ([872e607](https://github.com/pedrofuentes/arbol/commit/872e6077b3efaece70a48cf800ff9344a38e529c))
* use 'No' instead of 'Cancel' on save preset prompt ([e543be4](https://github.com/pedrofuentes/arbol/commit/e543be4b645d927dffcc24d3315ac77cb487c10a))
* use bottom-up manager levels (M1=only ICs, M2=has M1s, etc.) ([3166541](https://github.com/pedrofuentes/arbol/commit/3166541a5df794b32f05d146be8a87fa18111fbe))
* use color overrides instead of opacity for diff dimming ([ebd674c](https://github.com/pedrofuentes/arbol/commit/ebd674cc330e6c7b83679d38064b7a410da18ea1))
* use Ctrl+K label instead of ⌘K for Windows compatibility ([3a03a6e](https://github.com/pedrofuentes/arbol/commit/3a03a6e139505140c0b2fb282c01a80a752b3431))
* use Default layout preset for first-time users ([4b58960](https://github.com/pedrofuentes/arbol/commit/4b58960ac37865a85a442f38557e2502c736a6be))
* use generic names in preview tree and add dotted line ([d54f6a1](https://github.com/pedrofuentes/arbol/commit/d54f6a17e5bb47f89997995b911e98353083c578))
* use position:fixed for sidebar chevron to avoid layout breakage ([ed880f2](https://github.com/pedrofuentes/arbol/commit/ed880f2fb2fd019bcee29a9dd1d79829aa14038b))
* use styled data-tooltip on chart/version action buttons ([f59ecca](https://github.com/pedrofuentes/arbol/commit/f59ecca414102cbd8757c5ba6f75b33fa128ddae))
* validate inputs before snapshot in OrgStore mutations ([9bf9df7](https://github.com/pedrofuentes/arbol/commit/9bf9df76a21798fb072f2c057aa2e697bdd4882d))
* validate trees on backup restore and legacy migration ([25faa03](https://github.com/pedrofuentes/arbol/commit/25faa0389f2a7366f491f921b51ef14b57059c98))
* versions unchecked by default in export + PPTX uses mapped titles ([7304212](https://github.com/pedrofuentes/arbol/commit/73042129fd2f72bf61308cff2ece56d5f6a5cf4e))
* wire ~35 hardcoded strings to existing i18n keys ([5969f72](https://github.com/pedrofuentes/arbol/commit/5969f72d33167df8689d7a3955bacf60f33825d1))
* wire keyboard select handlers for SVG navigation ([f604227](https://github.com/pedrofuentes/arbol/commit/f60422716b4c0ff6cea6ff050b80c0cf3aa5676b))
* wire LoadingOverlay to exports and chart switching ([cbcbee5](https://github.com/pedrofuentes/arbol/commit/cbcbee515abb0f748bf1390ee79d64157724917d))


### Performance Improvements

* add nodeId→node Map index to OrgStore ([85217ff](https://github.com/pedrofuentes/arbol/commit/85217ff739c2c54a69e1025328fadbf0f923608d))
* batch rerender calls with requestAnimationFrame ([1a780c0](https://github.com/pedrofuentes/arbol/commit/1a780c0b1e38f59ce0ab8846c08d229c8be0f76c))
* debounce IndexedDB saves with 500ms delay ([fb2f883](https://github.com/pedrofuentes/arbol/commit/fb2f88327fea6c9583988726c3c7f6f24a8e1b2b))
* eliminate O(n²) algorithms and optimize rendering pipeline ([c6aab06](https://github.com/pedrofuentes/arbol/commit/c6aab064e8c0378b74a187ce0c02165b7ac7f53f))
* optimize CSS transitions, hover handlers, and backdrop blur ([f8f361c](https://github.com/pedrofuentes/arbol/commit/f8f361c230b0d83f709a2cbfd3772b972af91807))
* optimize tree traversals and add search cache ([a2a6ef1](https://github.com/pedrofuentes/arbol/commit/a2a6ef19df1b1a6c249ab0ec7f3f2d2f607fbb52))
