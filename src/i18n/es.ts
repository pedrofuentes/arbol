const es: Record<string, string> = {
  ...
  'analytics.focus_note': 'Mostrando métricas del equipo de {name}',
  'analytics.section.headcount': 'Resumen de personal',
  'analytics.people': '{count} personas',
  'analytics.managers': 'Gerentes',
  'analytics.ics': 'Colaboradores individuales',
  'analytics.advisors': 'Asesores',
  'analytics.manager_ic_ratio': 'Ratio gerente-CI',
  'analytics.ratio_format': '1 : {value}',
  'analytics.section.structure': 'Forma de la estructura',
  'analytics.org_depth': 'Profundidad del organigrama',
  'analytics.org_depth_value': '{count} niveles',
  'analytics.avg_depth': 'Profundidad promedio',
  'analytics.avg_depth_value': '{value} niveles',
  'analytics.layer_headcount': 'Personal por nivel',
  'analytics.layer_n': 'N{n}',
  'analytics.section.span': 'Tramo de control',
  'analytics.span_avg': 'Promedio',
  'analytics.span_min': 'Mínimo',
  'analytics.span_max': 'Máximo',
  'analytics.span_median': 'Mediana',
  'analytics.span_direct_reports': '{count} reportes directos',
  'analytics.wide_span_title': 'Tramo amplio (>{threshold})',
  'analytics.wide_span_desc': '{count} gerente(s) excediendo {threshold} reportes directos',
  'analytics.narrow_span_title': 'Tramo reducido (<{threshold})',
  'analytics.narrow_span_desc': '{count} gerente(s) debajo de {threshold} reportes directos',
  'analytics.single_child_title': 'Gerentes con un solo reporte',
  'analytics.single_child_desc': '{count} gerente(s) con solo 1 reporte directo',
  'analytics.no_alerts': 'Sin alertas de tramo de control',
  'analytics.section.levels': 'Distribución por nivel',
  'analytics.no_levels': 'Sin niveles asignados',
  'analytics.group_by_band': 'Agrupar por banda',
  'analytics.show_individual': 'Mostrar individual',
  'analytics.nodes_without_level': '{count} sin nivel',
  ...
  'command_palette.item_export_chart_data': 'Exportar datos del organigrama',
  'command_palette.item_delete_chart': 'Eliminar organigrama',
  'command_palette.item_view_version': 'Ver versión: {name}',
  'command_palette.item_compare_version': 'Comparar versión: {name}',
  'command_palette.item_restore_version': 'Restaurar versión: {name}',
  'command_palette.item_delete_version': 'Eliminar versión: {name}',
  ...
  'property_panel.mapped_title': 'Título mapeado',
  ...
  'dialog.delete_chart.title': '¿Mover el organigrama a la papelera?',
  'dialog.delete_chart.message':
    '¿Mover "{name}" a la papelera? Puede restaurarlo después desde Configuración → Datos y respaldo.',
  'dialog.delete_chart.confirm': 'Mover a la papelera',
  'dialog.delete_version.title': '¿Mover la versión a la papelera?',
  'dialog.delete_version.message':
    '¿Mover la versión "{name}" a la papelera? Puede restaurarla después desde Configuración → Datos y respaldo.',
  'dialog.delete_version.confirm': 'Mover a la papelera',
  ...
  'chart_editor.no_active_chart': 'No hay un organigrama activo',
  ...
  // ─── Toolbar (Step 6) ──────────────────────────────────────────────
  'toolbar.export_tooltip': 'Exportar (Ctrl+E)',
  ...
  // ─── Export Dialog ─────────────────────────────────────────────────
  'export_dialog.title': 'Exportar a PowerPoint, SVG o PNG',
  ...
  'settings_modal.tab.appearance': 'Apariencia',
  'settings_modal.tab.layout': 'Disposición',
  'settings_modal.tab.cards_badges': 'Tarjetas e insignias',
  'settings_modal.tab.levels_categories': 'Niveles y categorías',
  'settings_modal.tab.presets': 'Preajustes',
  'settings_modal.tab.data_backup': 'Datos y respaldo',
  'trash.title': 'Papelera',
  'trash.empty': 'La papelera está vacía.',
  'trash.charts_heading': 'Organigramas',
  'trash.versions_heading': 'Versiones',
  'trash.deleted_date': 'Eliminado el {date}',
  'trash.version_chart': 'Organigrama: {name}',
  'trash.unknown_chart': 'Organigrama desconocido',
  'trash.restore': 'Restaurar',
  'trash.delete_forever': 'Eliminar para siempre',
  'trash.delete_forever_title': '¿Eliminar para siempre?',
  'trash.delete_forever_message':
    '¿Eliminar permanentemente "{name}"? Esta acción no se puede deshacer.',
  'trash.load_failed': 'No se pudo cargar la papelera: {error}',
  'trash.action_failed': 'Falló la acción de la papelera: {error}',
  ...
  'settings.label.raw_level_placeholder': 'ej., L10, E5',
  'settings.label.display_title_placeholder': 'ej., IC, Senior',
  'settings.label.no_mappings': 'No hay mapeos de nivel definidos. Agregue uno a continuación.',
  'settings.label.import_csv': 'Importar desde CSV',
  'settings.label.export_csv': 'Exportar a CSV',
  'settings.label.mapping_imported': '{count} mapeo(s) importado(s)',
  'settings.label.delete_mapping': 'Eliminar mapeo',
  'settings.label.mapping_duplicate_error': 'Ya existe un mapeo para este nivel.',

  'column_mapper.level_column': 'Columna de nivel (opcional)',
};
