const es: Record<string, string> = {
  ...
  'settings.label.display_mode': 'Modo de visualización',
  'settings.label.display_mode_raw': 'Nivel original',
  'settings.label.display_mode_mapped': 'Título mapeado',
  'settings.label.display_mode_both': 'Ambos (Original — Título)',
  'settings.desc.display_mode': 'Cómo se muestran los valores de nivel en las tarjetas y exportaciones.',
