const en: Record<string, string> = {
  ...
  'settings.label.display_mode': 'Display Mode',
  'settings.label.display_mode_raw': 'Raw Level',
  'settings.label.display_mode_mapped': 'Mapped Title',
  'settings.label.display_mode_both': 'Both (Raw — Title)',
  'settings.desc.display_mode': 'How level values appear on cards and in exports.',
  'settings.label.add_mapping': 'Add Mapping',
  'settings.label.raw_level': 'Raw Level',
  'settings.label.display_title': 'Display Title',
  'settings.label.raw_level_placeholder': 'e.g., L10, E5',
  'settings.label.display_title_placeholder': 'e.g., IC, Senior',
