const en: Record<string, string> = {
  ...
  'command_palette.item_export_chart_data': 'Export chart data',
  'command_palette.item_delete_chart': 'Delete chart',
  'command_palette.item_view_version': 'View version: {name}',
  'command_palette.item_compare_version': 'Compare version: {name}',
  'command_palette.item_restore_version': 'Restore version: {name}',
  'command_palette.item_delete_version': 'Delete version: {name}',
  ...
  'settings_modal.search_placeholder': 'Search settings…',
  'settings_modal.search_aria': 'Search settings',
  'settings_modal.search_no_results': 'No settings found. Try different keywords.',
  'settings_modal.preview_title': 'Live Preview',
  'settings_modal.preview_hint.appearance': 'Theme and color changes highlighted',
  ...
  'settings_modal.preview_hint.cards_badges': 'Card and badge styling highlighted',
  'settings_modal.preview_hint.levels_categories': 'Level and category styling highlighted',
  ...
  'dialog.delete_chart.title': 'Move Chart to Trash?',
  'dialog.delete_chart.message':
    'Move "{name}" to Trash? You can restore it later from Settings → Data & Backup.',
  'dialog.delete_chart.confirm': 'Move to Trash',
  'dialog.delete_version.title': 'Move Version to Trash?',
  'dialog.delete_version.message':
    'Move version "{name}" to Trash? You can restore it later from Settings → Data & Backup.',
  'dialog.delete_version.confirm': 'Move to Trash',
  ...
  'chart_editor.no_active_chart': 'No active chart',
  ...
  'settings_modal.tab.appearance': 'Appearance',
  'settings_modal.tab.layout': 'Layout',
  'settings_modal.tab.cards_badges': 'Cards & Badges',
  'settings_modal.tab.levels_categories': 'Levels & Categories',
  'settings_modal.tab.presets': 'Presets',
  'settings_modal.tab.data_backup': 'Data & Backup',
  'trash.title': 'Trash',
  'trash.empty': 'Trash is empty.',
  'trash.charts_heading': 'Charts',
  'trash.versions_heading': 'Versions',
  'trash.deleted_date': 'Deleted {date}',
  'trash.version_chart': 'Chart: {name}',
  'trash.unknown_chart': 'Unknown chart',
  'trash.restore': 'Restore',
  'trash.delete_forever': 'Delete forever',
  'trash.delete_forever_title': 'Delete Forever?',
  'trash.delete_forever_message': 'This will permanently delete "{name}". This cannot be undone.',
  'trash.load_failed': 'Failed to load Trash: {error}',
  'trash.action_failed': 'Trash action failed: {error}',
