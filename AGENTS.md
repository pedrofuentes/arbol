...
3. **All 1,786 tests must pass** (`npm run test`) before any commit.
...
73 TypeScript source files in `src/`, organized by concern:
...
- **1,786 tests across 69 files** — all must pass before committing
