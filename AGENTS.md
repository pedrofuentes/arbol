...
3. **All 2,485 tests must pass** (`npm run test`) before any commit.
...
- `npm run test` must pass before every commit (2,485 tests)
...
- **2,485 tests across 99 files** — all must pass before committing
